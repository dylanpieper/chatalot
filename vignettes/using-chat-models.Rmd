...
This package provides two ways to use [ellmer chat
models](%5Bellmer%20chat%20model%20function%5D(https://ellmer.tidyverse.org/reference/index.html))
for batch processing. This flexibility allows you to 1) pass a function
that creates a ready-to-go chat model or 2) pass a chat model object for
more user control.
...
# Sequential processing
chat <- chat_batch(chat_model = claude)
